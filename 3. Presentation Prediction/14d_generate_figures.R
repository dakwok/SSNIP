...
# Load Files --------------------------------------------------------------
setwd(directory_14)
nmer_08 = read_tsv("2023_0812_mhcflurry_08mer_selected_alleles.tsv", col_names = T)
nmer_09 = read_tsv("2023_0812_mhcflurry_09mer_selected_alleles.tsv", col_names = T)
nmer_10 = read_tsv("2023_0812_mhcflurry_10mer_selected_alleles.tsv", col_names = T)
nmer_11 = read_tsv("2023_0812_mhcflurry_11mer_selected_alleles.tsv", col_names = T)
...
###########################################################################
for (i in 1:5){
  if (i == 1){plot_i = nmer_08_unique;  title_i = "8-mers (n=12479)";  filename_i = "2023_0812_histogram_all_08mer_n13320.pdf"}
  if (i == 2){plot_i = nmer_09_unique;  title_i = "9-mers (n=12794)";  filename_i = "2023_0812_histogram_all_09mer_n13659.pdf"}
